...
export class SingleComponent implements OnInit {
  ...
  private postsService: PostsService,private flashMessagesService: FlashMessagesService
  ,private globalService: GlobalService, private authenticationService: AuthenticationService,private stompService: StompService) {
	  ...
	  if(registroId){
        ...
        this.postsService.getRegistroById(registroId).subscribe(
			...
			this.router.navigate(["/home/paciente/posts"], {relativeTo: this.activatedRoute});
	  }
  }
